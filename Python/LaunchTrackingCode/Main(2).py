...
def switch_to_automatic_tracking():
    ...
    while terminate_active:
        ...
        if message:
            ...
            if payload_alt is not None and (coordinate2[0] > -12z3.8571589028068 or coordinate2[0] < -70.51451627738275 or coordinate2[1] < 49.53851441184275 or coordinate2[1] > 25.272085123304667) :
